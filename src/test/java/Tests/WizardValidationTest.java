...
private static ExtentReports extent;
    ...
    public void loginAndOpenWizard() {
        ...
        screenshotHelper.takesSnapShot(driver, "1_LoginPage");

        test.info("Logging in");
        loginPage.enterLoginEmail("mnengisaambesiwe@gmail.com");
        loginPage.enterPasswordId("@12345678");
        loginPage.clickLogin();
        screenshotHelper.takesSnapShot(driver, "3_LoginSuccessful");
        ...
        screenshotHelper.takesSnapShot(driver, "4_WizardPage");
    }
